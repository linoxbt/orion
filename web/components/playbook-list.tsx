...
/** The negotiation playbooks, rendered wherever they are explained.
 *
 * Lifted out of its own page so the docs can show the real strategies rather
 * than describing them second-hand and drifting out of date.
 */
